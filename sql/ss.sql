...
INSERT INTO MEMBER (MEMBER_NO, MEMBER_ID, MEMBER_PW, MEMBER_NICKNAME, MEMBER_NAME, MEMBER_EMAIL, MEMBER_GENDER, MEMBER_BIRTHDAY, ENROLL_DATE, MEMBER_STATUS, MEMBER_PHONENUMBER, TUTOR_SCHOOL_AUTHORIZE, TUTOR_MIDDLE_SCHOOL, TUTOR_HIGH_SCHOOL, TUTOR_UNI, TUTOR_UNI_IS_ENROLLED, TUTOR_MAJOR, TUTOR_MAJOR_NUM, TUTOR_AUTHORIZE, `KEY`, MEMBER_CURRENT_STATUS, MEMBER_ENROLL_DATE, MEMBER_PHONE_NUMBER, MY_KEY) VALUES (10000000, 'admin', '(암호화해서 저장)', 'admin', '관리자', 'admin@tutorlink.com', 'F', 19900101, 'A', 1000000000, 'T', '관리자', '관리자', '', '', '', '', '', '', 1),       (10000001, 'jihyevivianako', '(암호화해서 저장)', 'vivi', '고지혜', 'jihyevivianako@gmail.com', 'F', 20000429, 'A', 1033332222, 'T', '성내중학교', '둔촌고등학교', 'univ_code021', 'T', '컴퓨터공학부', 20, '', '', 'pss_code01', 2),       (10000002, 'honghong22', '(암호화해서 저장)', 'hong', '홍길동', 'honggildong@gmail.com', 'M', 19920420, 'A', 1033333333, 'T', '한산중학교', '동북고등학교', 'univ_code001', 'F', '경영학과', 13, '', '', 'pss_code01', 2),       (10000003, 'lululala1020', '(암호화해서 저장)', 'lulu', '김루루', 'rurururu@naver.com', 'F', 20021026, 'A', 1099999999, 'F', '영파여자중학교', '영파여자고등학교', '', '', '', '', '', '', 3),       (10000004, 'hanmiyeon20', '(암호화해서 저장)', 'mimiyeon', '한미연', 'yeonhanhan@naver.com', 'F', 19990304, 'A', 1056789123, 'F', '둔둔중학교', '둔둔고등학교', '', '', '', '', '', '', 3);
...
INSERT INTO class_information (member_no, subject_code, info_cost, info_content, style_code)VALUES    ('10000001', 'sub004', '20000', '[8주 완성] 수1 개념 빠르게 1회독진행해드립니다.1주일에 한번씩 단원평가를 진행합니다.', 'sty001'),    ('10000001', 'sub007', '25000', '[수능 전문] 미적분 과목 모의고사 과외합니다.', 'sty002');

CREATE TABLE UNIVERSITY (  univ_code VARCHAR(20),     univ_name VARCHAR(50),     category_code VARCHAR(10));
