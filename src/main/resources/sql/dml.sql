...
#게시글 임시값 insert
INSERT INTO POST(post_writer, category_code, post_title, post_content, post_is_deleted, post_regist_date, post_update_date, post_delete_date, post_status)
VALUES(1, 'CATEGORY001', '2023생윤 자료 공유해요', '직접 제작한 생윤 모의고사 2회차 입니다. 답지와 함께 첨부했으니 풀어보세요!', 'N', '2023-10-18 03:27:33', NULL, NULL, 'A'),
      (1, 'CATEGORY004', '수능 자료 제작하느라 너무 힘들었네요','모의고사 2회 제작이 이렇게 오래 걸리는 일인지 몰랐습니다! 그래도 뿌듯하네요', 'N', '2023-10-18 3:33:23', '2023-10-18 3:58:01', NULL, 'A'),
      (1, 'CATEGORY004', '사문 VS 윤사 뭐 선택해야 할까요', '예비 고3인데 윤리과목이 재밌어요. 근데 다른 친구들은 생윤, 사문을 많이 해서..', 'Y', '2023-10-18 14:23:11', NULL, '2023-10-18 20:22:11', 'U'),
      (2, 'CATEGORY004', '금천구 국어 선생님 추천 받아요 ^^', '지인 소개로 수학 선생님은 구했는데 국어 선생님이 필요할 것 같아요', 'N', '2023-10-19 16:23:11', NULL, NULL, 'A'),
      (2, 'CATEGORY003', '3개월만에 영어 6->2 가능합니다.', '제 방식을 따라 온 친구들은 ..', 'N', '2023-10-20 19:11:45', NULL, NULL, 'A');
select * from POST;
